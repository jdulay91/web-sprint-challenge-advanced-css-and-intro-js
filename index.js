...
const myInfo = [{
  ...
  bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras eu ante turpis. Suspendisse potenti. Integer commodo nec lorem ullamcorper cursus. In hac habitasse platea dictumst. Etiam elementum, diam maximus lobortis tincidunt, justo nibh hendrerit dolor, at tempus libero ex et libero. Vestibulum molestie mi lectus, non commodo ligula condimentum eget. '
}];
...
function lotsOfArt(arr){
  ...
  for(let i =0; i<arr.length;i++){
    if(arr[i].paintings>100){
      lotsOfArtwork.push(arr[i].name);
    }
  } return lotsOfArtwork;
}
